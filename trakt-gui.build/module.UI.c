...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "UI", 7);
...
void checkModuleConstants_UI(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "UI", 7);
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "UI";

// Internal entry point for module code.
PyObject *modulecode_UI(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    module_UI = module;
...
// Mark the execution in the "__spec__" value.
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT1(moduledict_UI, (Nuitka_StringObject *)mod_consts[5], tmp_assign_source_1);
    }
